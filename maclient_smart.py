...
key_cn_ = {'res': 'A1dPUcrvur2CRQyl', 'helper':'A1dPUcrvur2CRQyl', 'crypt':'yG07yHJZoAlsofBh5XmlVQ=='.decode('base64')}
...
app_ver_jp = 236
# wake
name_wake_rare = ['NICE', '好船']
name_wake = name_wake_rare + ['觉醒', '覺醒', '裏']
